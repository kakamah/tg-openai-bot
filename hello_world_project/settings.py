...
SECRET_KEY = 'django-insecure-#e@09@i+tckux0#nt1om&ywb=24isoc5%*-2i+u20u3*73gbs%'
...
AUTHENTICATION_BACKENDS = ['api.backends.MultiFieldAuthBackend']
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'LearnWeb API',
    'DESCRIPTION': 'Django REST API with Telegram bot integration and AI chat.',
    'VERSION': '1.0.0',
